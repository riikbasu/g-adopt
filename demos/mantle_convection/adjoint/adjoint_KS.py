...
rol_algorithm = ROL.KelleySachsAlgorithm(rol_params, rol_secant)

solutions_vtk = VTKFile("solutions_KS.pvd")
...
with open("functional_KS.txt", "w") as f:
