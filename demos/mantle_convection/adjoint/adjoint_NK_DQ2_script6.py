...
new_checkpoint_filename = 'Final_State_new_new_new_new.h5'
...
solutions_vtk = VTKFile("solutions_NK_DQ2_script6.pvd")
...
my_file = CheckpointFile("Final_State_new_new_new_new_new.h5", "w")
...
class StatusTest(ROL.StatusTest):
    def check(self, status):
        ...
        if MPI.COMM_WORLD.Get_rank() == 0:        
            with open("functional_NK_DQ2_script6.txt", "a") as f:
