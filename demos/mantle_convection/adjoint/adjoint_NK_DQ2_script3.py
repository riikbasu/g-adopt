...
solutions_vtk = VTKFile("solutions_NK_DQ2_script3.pvd")
...
class StatusTest(ROL.StatusTest):
    def check(self, status):
        ...
        if MPI.COMM_WORLD.Get_rank() == 0:        
            with open("functional_NK_DQ2_script3.txt", "a") as f:
        ...
        # Write checkpoint
        with CheckpointFile("Final_State_new_new.h5", "w") as final_checkpoint:
