...
rol_algorithm = ROL.NewtonKrylovAlgorithm(rol_params, rol_secant)

solutions_vtk = VTKFile("solutions_NK_bounded.pvd")
...
with open("functional_NK_bounded.txt", "w") as f:
