...
averager = LayerAveraging(
    mesh, np.linspace(0, 1.0, 300 * 2), quad_degree=6
)
...
checkpoint_file = CheckpointFile("adjoint-demo-checkpoint-state-highres.h5", "w")
...
# +
output_file = VTKFile("output_highres.pvd")  # Create output file for visualisation.
