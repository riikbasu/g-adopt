...
minimisation_parameters["Step"]["Line Search"] = {
    ...
    # "Initial Step Size": 1.25,
    # "Accept Linesearch Minimizer": True,
    # "Reset Step Size": True
...
solutions_vtk = VTKFile("solutions_NK_DQ2_BAD_new_tests.pvd")
...
class StatusTest(ROL.StatusTest):
    def check(self, status):
        ...
        if MPI.COMM_WORLD.Get_rank() == 0:        
            with open("functional_NK_DQ2_BAD_new_tests.txt", "a") as f:
