...
solutions_vtk = VTKFile("solutions_NK_DQ2_LM_test_iteration2.pvd")
...
my_file = CheckpointFile("Final_State_NK_DQ2_LM_test_iteration2.h5", "w")
...
class StatusTest(ROL.StatusTest):
    def check(self, status):
        ...
        if MPI.COMM_WORLD.Get_rank() == 0:        
            with open("functional_NK_DQ2_LM_test_iteration2.txt", "a") as f:
