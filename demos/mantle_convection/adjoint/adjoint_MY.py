...
rol_algorithm = ROL.MoreauYosidaAlgorithm(rol_params, rol_secant)

solutions_vtk = VTKFile("solutions_MY.pvd")
...
with open("functional_MY.txt", "w") as f:
