...
rol_algorithm = ROL.InteriorPointAlgorithm(rol_params, rol_secant)

solutions_vtk = VTKFile("solutions_IPA.pvd")
...
with open("functional_IPA.txt", "w") as f:
