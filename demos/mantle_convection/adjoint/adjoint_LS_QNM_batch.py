...
def LS_QNM_batch(functional_file, parameter_set, line_search_type, curvature_condition, initial_step_size, sufficient_decrease_tol, general_parameter):
    ...
    minimisation_parameters["Step"]["Line Search"] = {
        "Line-Search Method": {"Type": line_search_type},
        ...
        # "Use Previous Step Length as Initial Guess": use_prev_step,
        # "Accept Linesearch Minimizer": accept_ls_minimiser,
        "Sufficient Decrease Tolerance": sufficient_decrease_tol,
        "Curvature Condition": {"General Parameter": general_parameter},
    }
    ...
    solutions_vtk = VTKFile("solutions_LS_QNM_" + str(parameter_set) + ".pvd")
...
def main():
    ...
    initial_step_size = sys.argv[5]
    sufficient_decrease_tol = sys.argv[6]
    general_parameter = sys.argv[7]
    LS_QNM_batch(functional_file, parameter_set, line_search_type, curvature_condition, initial_step_size, sufficient_decrease_tol, general_parameter)
