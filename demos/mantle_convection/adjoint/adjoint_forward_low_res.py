...
averager = LayerAveraging(
    mesh, np.linspace(0, 1.0, 30 * 2), quad_degree=6
)
...
checkpoint_file = CheckpointFile("adjoint-demo-checkpoint-state-lowres.h5", "w")
...
# +
output_file = VTKFile("output_lowres.pvd")  # Create output file for visualisation.
