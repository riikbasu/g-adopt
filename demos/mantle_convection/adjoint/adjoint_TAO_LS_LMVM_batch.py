...
def TAO_LS_LMVM(functional_file, tao_lmm_vectors, tao_ls_type, tao_ls_ftol, tao_ls_gtol, tao_ls_stepmin, tao_ls_stepmax, tao_ls_rtol):
    ...
    solutions_vtk = VTKFile("solutions_TAO_LS_LMVM_gtol.pvd")
    ...
    solver = TAOSolver(minimisation_problem, {
        ...
        # -------------------------------------------------------
        "tao_lmm_vectors": tao_lmm_vectors,                        # Number of stored (s,y) correction pairs; default: 5
        ...
        # -------------------------------------------------------
        "tao_ls_type": tao_ls_type,               # Line search ('more-thuente'|'armijo'|'gpcg'); default: 'more-thuente'
        "tao_ls_ftol": tao_ls_ftol,                         # Armijo sufficient decrease parameter; default: 1e-4
        "tao_ls_gtol": tao_ls_gtol,                          # Curvature (Wolfe) tolerance; default: 0.9
        "tao_ls_stepmin": tao_ls_stepmin,                     # Minimum step length allowed; default: 1e-20
        "tao_ls_stepmax": tao_ls_stepmax,                      # Maximum step length allowed; default: 1e10
        "tao_ls_rtol": tao_ls_rtol,                        # Relative line-search tolerance; default: 1e-10
...
def main():
    ...
    tao_lmm_vectors = sys.argv[3]
    tao_ls_type = sys.argv[4]
    tao_ls_ftol = sys.argv[5]
    tao_ls_gtol = sys.argv[6]
    tao_ls_stepmin = sys.argv[7]
    tao_ls_stepmax = sys.argv[8]
    tao_ls_rtol = sys.argv[9]
    # functional_file = "functional_TAO_LS_LMVM_tests_1.txt"
    # tao_lmm_vectors = 5
    # tao_ls_type = "more-thuente"
    # tao_ls_ftol = 1e-4
    # tao_ls_gtol = 0.9
    # tao_ls_stepmin = 1e-20
    # tao_ls_stepmax = 1e10
    # tao_ls_rtol = 1e-10
    TAO_LS_LMVM(functional_file, tao_lmm_vectors, tao_ls_type, tao_ls_ftol, tao_ls_gtol, tao_ls_stepmin, tao_ls_stepmax, tao_ls_rtol)
