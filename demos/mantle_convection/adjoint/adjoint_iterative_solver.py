...
energy_solver.solver_parameters['ksp_rtol'] = 1e-5
# energy_solver.solver_parameters['fieldsplit_0']['ksp_rtol'] = 1e-5
# energy_solver.solver_parameters['fieldsplit_1']['ksp_rtol'] = 1e-6
...
stokes_solver.solver_parameters['fieldsplit_0']['ksp_rtol'] = 1e-5
stokes_solver.solver_parameters['fieldsplit_1']['ksp_rtol'] = 1e-6
...
u_misfit = 0.0
z.subfunctions[0].assign(0.0)
z.subfunctions[1].assign(0.0)
