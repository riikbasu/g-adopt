...
# ## Using TrustRegionSPG Algorithm
...
rol_algorithm = ROL.TrustRegionSPGAlgorithm(rol_params, rol_secant)

solutions_vtk = VTKFile("solutions_TSPG.pvd")
...
with open("functional_TSPG.txt", "w") as f:
