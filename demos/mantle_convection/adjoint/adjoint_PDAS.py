...
# ## Using PrimalDualActiveSet Algorithm
...
rol_algorithm = ROL.PrimalDualActiveSetAlgorithm(rol_params, rol_secant)

solutions_vtk = VTKFile("solutions_PDAS.pvd")
...
with open("functional_PDAS.txt", "w") as f:
